...
ui <- fluidPage(
  tabsetPanel(
    ...
    tabPanel("Percentage of Pop.", plotOutput("perc_plot"))
...
server <- function(input, output){
  ...
  output$pop_plot <- renderPlot({
        ...
        ggtitle("Vaccine Adminstration by Provinces")
        return(pop_p)
  })
...
ui <- fluidPage(
  tabsetPanel(
    tabPanel("Alberta", plotOutput("ALB_plot"),height ="150%"),
    tabPanel("British Columbia", plotOutput("BC_plot"),height ="150%"),
    tabPanel("Manitoba", plotOutput("MAN_plot"),height ="150%"),
    tabPanel("New Brunswick", plotOutput("NB_plot"),height ="150%"),
    tabPanel("Newfoundland and Labrador", plotOutput("NF_plot"),height ="150%"),
    tabPanel("Northwest Territories", plotOutput("NT_plot"),height ="150%"),
    tabPanel("Nova Scotia", plotOutput("NS_plot"),height ="150%"),
    tabPanel("Nunavut", plotOutput("NUN_plot"),height ="150%"),
    tabPanel("Prince Edward Island", plotOutput("PEI_plot"),height ="150%"),
    tabPanel("Quebec", plotOutput("QU_plot"),height ="150%"),
    tabPanel("Saskatchewan", plotOutput("SAS_plot"),height ="150%"),
    tabPanel("Yukon", plotOutput("YUK_plot"),height ="150%")
  )
)
